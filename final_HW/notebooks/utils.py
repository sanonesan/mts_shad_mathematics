...
from sklearn.metrics import roc_auc_score, classification_report, roc_curve, roc_auc_score, f1_score, precision_score, recall_score, confusion_matrix
...
def train_binary(dataset, target, feature_names, plot_feature, model_type='logit', pkg='sklearn', class_weight=None):
    ...
    if pkg == 'statsmodels':
        ...
        if class_weight is None:
            ...
            model = LogisticRegression(class_weight=class_weight, max_iter=500).fit(X, dataset[target])
